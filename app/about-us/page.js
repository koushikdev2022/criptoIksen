        ...
        <div className="max-w-6xl mx-auto lg:py-4 px-4 lg:px-0">
          <div className="lg:flex">
            ...
            <div className="lg:w-6/12 lg:pl-10 flex justify-center items-center">
              <div>
                <p className="text-[#69697B] font-medium text-base leading-[24px] lg:text-[18px] lg:leading-[28px] pb-4">CryptoIntuit was born from the frustration of digging through data and charts. We built a platform that does the heavy lifting for you — so you can make faster, smarter decisions with clarity.</p>
                <h2 className="text-[#0B0B2C] text-xl lg:text-3xl lg:leading-[50px] font-extrabold capitalize pb-0">Mission</h2>
                <p className="text-[#69697B] font-medium text-base leading-[24px] lg:text-[18px] lg:leading-[28px] pb-4">Democratize crypto trading insights.</p>
                <h2 className="text-[#0B0B2C] text-xl lg:text-3xl lg:leading-[50px] font-extrabold capitalize pb-0">Vision</h2>
                <p className="text-[#69697B] font-medium text-base leading-[24px] lg:text-[18px] lg:leading-[28px] pb-4">Become the AI co-pilot for every crypto investor.</p>
              </div>
            </div>
          </div>
        </div>
